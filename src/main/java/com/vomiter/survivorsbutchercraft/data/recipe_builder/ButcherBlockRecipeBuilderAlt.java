...
public class ButcherBlockRecipeBuilderAlt implements RecipeBuilder {
    ...
    public ButcherBlockRecipeBuilderAlt(Ingredient carcassIn) {
        this.ingredient = carcassIn;
    }

    public static ButcherBlockRecipeBuilderAlt shapedRecipe(Ingredient resultIn) {
        return new ButcherBlockRecipeBuilderAlt(resultIn);
    }

    public ButcherBlockRecipeBuilderAlt tool(Ingredient tool, int count, int uses, boolean damage, ResourceLocation table, BlacklistedModel... model) {
        this.tools.add(new AnimatedRecipeItemUse(uses, tool, count, damage, table, model));
        return this;
    }

    public ButcherBlockRecipeBuilderAlt tool(Ingredient tool, int uses, boolean damage, ResourceLocation table, BlacklistedModel... model) {
        this.tools.add(new AnimatedRecipeItemUse(uses, tool, 1, damage, table, model));
        return this;
    }

    public ButcherBlockRecipeBuilderAlt JEIIngredient(Ingredient i) {
        this.jei.add(i);
        return this;
    }
    ...
    public static class Result implements FinishedRecipe {
        ...
        public Result(ResourceLocation idIn, Ingredient carcassIn, String groupIn, List<AnimatedRecipeItemUse> toolsIn, List<Ingredient> JEI, Builder advancementBuilderIn, ResourceLocation advancementIdIn) {
            this.id = idIn;
