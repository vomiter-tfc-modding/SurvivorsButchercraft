...
public class CustomButcherBlockRecipe extends ButcherBlockRecipe implements IButcherRecipe{
    ...
    public static class Serializer implements RecipeSerializer<CustomButcherBlockRecipe> {
        ...
        public CustomButcherBlockRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
            ...
            return new CustomButcherBlockRecipe(pRecipeId, group, carcass, recipeItemUses, jei, chanceResults);
        }
        ...
        public CustomButcherBlockRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
            ...
            return new CustomButcherBlockRecipe(recipeId, group, carcassIn, tools, jei, chanceResults);
        }

        public void toNetwork(FriendlyByteBuf buffer, CustomButcherBlockRecipe recipe) {
